...
curl -sSL [https://raw.githubusercontent.com/akhilreddy59/ollama-can-edit/main/ollama-file-editor.py](https://raw.githubusercontent.com/akhilreddy59/ollama-can-edit/main/ollama-file-editor.py) -o ollama-editor.py
